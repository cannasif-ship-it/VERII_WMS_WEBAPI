...
namespace WMS_WEBAPI.Services
{
    public class WtRouteService : IWtRouteService
    {
        ...
        public async Task<ApiResponse<IEnumerable<WtRouteDto>>> GetByStockCodeAsync(string stockCode)
        {
            try
            {
                var entities = await _unitOfWork.WtRoutes
        ...
        public async Task<ApiResponse<IEnumerable<WtRouteDto>>> GetByRouteCodeAsync(string routeCode)
        {
            try
            {
                var entities = await _unitOfWork.WtRoutes
