...
namespace WMS_WEBAPI.Controllers
{
    ...
    public class WtRouteController : ControllerBase
    {
        ...
        /// <summary>
        /// Stok koduna göre WtRoute kayıtlarını getirir
        /// </summary>
        /// <param name="stockCode">Stok kodu</param>
        /// <returns>WtRoute listesi</returns>
        [HttpGet("stock/{stockCode}")]
        public async Task<ActionResult<ApiResponse<IEnumerable<WtRouteDto>>>> GetByStockCode(string stockCode)
        {
            var result = await _wtRouteService.GetByStockCodeAsync(stockCode);
            return StatusCode(result.StatusCode, result);
        }
