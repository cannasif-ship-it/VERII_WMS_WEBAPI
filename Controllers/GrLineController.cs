...
namespace WMS_WEBAPI.Controllers
{
    ...
    public class GrLineController : ControllerBase
    {
        ...
        public async Task<ActionResult<ApiResponse<GrLineDto>>> Create([FromBody] CreateGrLineDto createDto)
        {
            ...
            {
                return StatusCode(400, ApiResponse<GrLineDto>.ErrorResult(_localizationService.GetLocalizedString("InvalidModelState"), ModelState?.ToString() ?? string.Empty, 400, default));
            }
        ...
        /// <summary>
        /// GR Line kaydının varlığını kontrol eder
        /// </summary>
        /// <param name="id">Kontrol edilecek GR Line ID</param>
