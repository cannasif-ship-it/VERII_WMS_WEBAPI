...
namespace WMS_WEBAPI.Controllers
{
    ...
    public class PtTerminalLineController : ControllerBase
    {
        ...
        [HttpGet("date-range")]
        public async Task<ActionResult<ApiResponse<IEnumerable<PtTerminalLineDto>>>> GetByDateRange([FromQuery] DateTime startDate, [FromQuery] DateTime endDate)
        {
        ...
        [HttpGet("active")]
        public async Task<ActionResult<ApiResponse<IEnumerable<PtTerminalLineDto>>>> GetActive()
        {
