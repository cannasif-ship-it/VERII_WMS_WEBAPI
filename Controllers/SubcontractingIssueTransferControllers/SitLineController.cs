...
namespace WMS_WEBAPI.Controllers
{
    ...
    public class SitLineController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<ApiResponse<IEnumerable<SitLineDto>>>> GetAll()
        {
        ...
        [HttpGet("paged")]
        public async Task<ActionResult<ApiResponse<PagedResponse<SitLineDto>>>> GetPaged([FromQuery] int pageNumber = 1, [FromQuery] int pageSize = 10, [FromQuery] string? sortBy = null, [FromQuery] string? sortDirection = "asc")
        {
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<ApiResponse<SitLineDto>>> GetById(long id)
        {
        ...
        public async Task<ActionResult<ApiResponse<IEnumerable<SitLineDto>>>> GetByHeaderId(long headerId)
        {
        ...
        [HttpGet("active")]
        public async Task<ActionResult<ApiResponse<IEnumerable<SitLineDto>>>> GetActive()
        {
        ...
        [HttpPut("{id}")]
        public async Task<ActionResult<ApiResponse<SitLineDto>>> Update(long id, [FromBody] UpdateSitLineDto updateDto)
        {
