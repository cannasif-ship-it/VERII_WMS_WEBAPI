...
namespace WMS_WEBAPI.Controllers
{
    ...
    public class SrtTerminalLineController : ControllerBase
    {
        ...
        [HttpGet("date-range")]
        public async Task<ActionResult<ApiResponse<IEnumerable<SrtTerminalLineDto>>>> GetByDateRange([FromQuery] DateTime startDate, [FromQuery] DateTime endDate)
        {
        ...
        [HttpGet("active")]
        public async Task<ActionResult<ApiResponse<IEnumerable<SrtTerminalLineDto>>>> GetActive()
        {
