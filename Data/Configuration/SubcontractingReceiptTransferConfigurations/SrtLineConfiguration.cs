...
{
    public class SrtLineConfiguration : BaseEntityConfiguration<SrtLine>
    {
        protected override void ConfigureEntity(EntityTypeBuilder<SrtLine> builder)
        {
            ...
            builder.Property(x => x.ErpOrderLineNo).HasMaxLength(10);
            builder.Property(x => x.ErpLineReference).HasMaxLength(10);
