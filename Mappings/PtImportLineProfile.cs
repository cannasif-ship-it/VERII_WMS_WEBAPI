    ...
    public class PtImportLineProfile : Profile
    {
        public PtImportLineProfile()
        {
            CreateMap<PtImportLine, PtImportLineDto>()
                ...
                .ForMember(dest => dest.ScannedBarkod, opt => opt.MapFrom(src => src.ScannedBarkod))
                .ForMember(dest => dest.ErpOrderNumber, opt => opt.MapFrom(src => src.ErpOrderNumber))
                .ForMember(dest => dest.ErpOrderNo, opt => opt.MapFrom(src => src.ErpOrderNo))
                .ForMember(dest => dest.ErpOrderLineNumber, opt => opt.MapFrom(src => src.ErpOrderLineNumber))
                .ForMember(dest => dest.ErpOrderSequence, opt => opt.MapFrom(src => src.ErpOrderSequence))
