...
{
    public class WtRouteProfile : Profile
    {
        public WtRouteProfile()
        {
            // WtRoute to WtRouteDto
            CreateMap<WtRoute, WtRouteDto>()
                ...
                .ApplyFullUserNames<WtRoute, WtRouteDto>();

            // CreateWtRouteDto to WtRoute
